...
insert into user_roles (user_id, roles) values ('12b34a1e-fdbf-4aa6-8ee6-a441b2312193', 0);
...
insert into user_roles (user_id, roles) values ('bbc620d2-b534-4e6f-91bf-8163a164df43', 0);
...
insert into user_roles (user_id, roles) values ('683cf076-0f88-4838-8e4f-91de1a78cfae', 0);
...
insert into user_roles (user_id, roles) values ('11e2191e-2056-43e7-be3b-b9b77066739e', 0);
...
insert into user_roles (user_id, roles) values ('323cddc9-09a1-4107-8e6d-9199aa2f7baf', 0);
...
insert into user_roles (user_id, roles) values ('9f771c2e-01b0-4fe1-adb7-45aa09eb4c1e', 0);
...
insert into user_roles (user_id, roles) values ('e31194db-3c18-47a5-bfdb-172ceebf7660', 0);
...
insert into user_roles (user_id, roles) values ('50c82e8c-d1ce-4a19-9cb0-c86ac638d6af', 1);
...
insert into user_roles (user_id, roles) values ('dceb21bb-275b-4255-ae6d-9826fb8c820d', 1);
...
insert into user_roles (user_id, roles) values ('dfa72e56-9b25-4344-b8ef-440208aadfda', 1);
...
insert into user_roles (user_id, roles) values ('4479e92b-4278-4d9a-b434-8703033ed298', 1);
...
insert into bar (created_at , description , address , image , name, owner_id, id) values ( '2023-02-05', 'Bar de toda la vida al mas puro estilo sevillano. Caracterizado por sus serranitos, también destacar su alioli y su flamenquin.', 'C/Justino Matute, 6', 'cibeles.jpg', 'Bar Cibeles 2', 'c8d2cf0d-1868-4ced-892a-27bea770def6', '80adfa7a-6a63-42f3-8a1e-153039544e7b');
insert into bar (created_at , description , address , image , name, owner_id, id) values ( '2023-02-06', 'Este clasico bar trianero lleva desde 1970 sirviendo codornices fritas y adobadas y son los pajaritos mas celebrados de toda Sevilla.', 'Avenida Santa Cecilia, 2', 'ruperto.jpg', 'Bar Ruperto', 'd9554666-0096-469d-96c2-eb20e31dcb23', 'c2dde920-80df-4743-86d4-3545269edcb7');
insert into bar (created_at , description , address , image , name, owner_id, id) values ( '2023-02-10', 'Es de los bares clasicos del barrio y su comida mas clasica todavia. Destaca sin duda por sus tortillitas de camarones, el adobo y las coquinas', 'C/San Jacinto, 4', 'bar-altozano.jpg', 'Cafe Bar Altozano de Triana', '5cbdc9a6-abb7-4b8d-9766-6edc374ed096','625cd031-1a54-4d3d-a6bc-b835909fa18e');
insert into bar (created_at , description , address , image , name, owner_id, id) values ( '2023-02-10', 'Ubicado en el antiguo faro de Triana, Maria Trifulca es una comida de lujo sobre el Guadalquivir y la opcion perfecta para ocasiones especiales.', 'Puente de Triana', 'maria-trifulca.jpg', 'Maria Trifulca', '117b5abd-b3e2-4b5e-a12a-f02b76204aee', 'a7b81431-43a1-4e72-8685-3647f12b3047');
insert into bar (created_at , description , address , image , name, owner_id, id) values ( '2023-02-12', 'Muy versatil, su moderna carta se adapta tanto a cenas romanticas como comidas de empresa, como tener la posibilidad de tomarte una copa etc sin perder ni un apice en modernidad o calidad en el servicio.', 'C/Betis, 69', 'abades.jpg', 'Abades Triana', '062a6a92-98eb-43c8-bbc0-4089b36962a4', 'a3c714bb-8588-4591-a7d1-3fa058304c9c');
insert into bar (created_at , description , address , image , name, owner_id, id) values ( '2023-02-13', 'Un lugar emblematico donde tomar algo, tambien imprescindible en el top ten de bares y restaurantes donde comer de tapas en Triana bien y barato.', 'C/San Jacinto, 16', 'patio-san-eloy.jpg', 'Patio de San Eloy', 'e70c9108-ddcf-416b-a957-01feed566a64', '912b2cb8-389f-408a-889d-95ea65250e67');
insert into bar (created_at , description , address , image , name, owner_id, id) values ( '2023-02-18', 'De los mejores lugares trianeros con diferencia. No es baratisimo pero merece mucho la pena por algunas de las exquisiteces que puedes tomar. Ademas dentro de la comida clasica suelen ser innovadores.', 'C/San Jacinto, 49', 'blanca-paloma.jpg', 'Blanca Paloma', '9d6076d7-233d-4111-bd19-1c589d2a2764', '3bb95209-da68-4f55-9eed-ba0001a1ad3c');
insert into bar (created_at , description , address , image , name, owner_id, id) values ( '2023-02-19', 'El macarron toro, las arepas y la pastela son algunas de las mejores comidas del lugar, por no hablar de los postres. Dejad un hueco (aunque sea complicado) para el cremoso de azafran.', 'C/Vega, 10', 'vega-10.jpg', 'Vega 10', '12b34a1e-fdbf-4aa6-8ee6-a441b2312193', '7055f932-a1ea-4fe7-a4b2-0da9a871f644');
insert into bar (created_at , description , address , image , name, owner_id, id) values ( '2023-02-20', 'Una tasca tradicional de las mas tipicas y uno de los mejores bares de tapas en Triana. Comida casera, con buenas raciones y de calidad.', 'C/Calle Alfareria, 5', 'casa-diego.jpg', 'Casa Diego', 'bbc620d2-b534-4e6f-91bf-8163a164df43', 'e0469d55-f941-44d0-93ae-1ffed49d300c');
insert into bar (created_at , description , address , image , name, owner_id, id) values ( '2023-02-20', 'Incluimos esta freiduria entre las recomendaciones para comer de tapas en Triana bien y barato, tal y como nos la dieron.', 'C/Rodrigo de Triana, 51', 'freiduria.jpg', 'Freiduria Reina Victoria', '683cf076-0f88-4838-8e4f-91de1a78cfae', 'a8046137-373a-40a7-85f3-8d5f241bbceb');
insert into bar (created_at , description , address , image , name, owner_id, id) values ( '2023-02-21', 'Cuidada restauracion tradicional en plena la calle Betis, con unas vistas de Sevilla excepcionales. Zona de restaurante más formal o terraza más distendida, una de las mejores de Sevilla. Carta amplia, con opción vegana o menu degustacion.', 'C/Betis, 69', 'rio-grande.jpg', 'Rio Grande', '11e2191e-2056-43e7-be3b-b9b77066739e', '63d502f3-3c5e-4eef-ae9c-21840e243faf');
insert into bar (created_at , description , address , image , name, owner_id, id) values ( '2023-02-22', 'Lugar recomendadisimo en todos los sentidos. El local está bien decorado y es acogedor. No hay una gran variedad pero eso es lo de menos, porque lo compensa con creces sus tataki de atun y sus croquetas de rabo de toro.', 'C/Victoria, 8', 'victoria.jpg', 'Victoria 8', '323cddc9-09a1-4107-8e6d-9199aa2f7baf', 'bf260a9b-3438-4067-b3d2-030b782b1388');
insert into bar (created_at , description , address , image , name, owner_id, id) values ( '2023-02-16', 'Una taberna donde comer en Triana de tapas o de raciones sentado en su terraza. No te pierdas el adobo, las acedias o el secreto. Tambien recomiendan las bandejas de pescaito frito, el rabo de toro y el arroz negro.', 'C/San Jacinto, 21', 'taberna-miami.jpg', 'Taberna Miami', '9f771c2e-01b0-4fe1-adb7-45aa09eb4c1e', 'bf7c2b27-6396-4abf-8eed-b93933290621');
insert into bar (created_at , description , address , image , name, owner_id, id) values ( '2023-02-08', 'Su amplia carta tiene manjares tales como: ensaladilla de pulpo, coca de gorgonzola, dados de atún rojo sobre pan, puntas de solomillo iberico y hamburguesa de ternera black angus...', 'C/Manuel Pareja Obregon, 2', 'trianilla.jpg', 'Trianilla', 'e31194db-3c18-47a5-bfdb-172ceebf7660', '464f01c6-7f8b-4afb-b9ba-44fdf9db9631');
