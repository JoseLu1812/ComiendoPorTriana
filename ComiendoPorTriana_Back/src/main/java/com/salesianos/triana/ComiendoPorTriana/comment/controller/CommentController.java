...
public class CommentController {
    ...
    @GetMapping("/comment")
    public Page<CommentDto> searchBarComments(@Parameter(name = "Search", description = "Filtros de busqueda para la petición")@RequestParam(value = "search", defaultValue = "") String search,
